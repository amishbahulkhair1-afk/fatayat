...
<x-app-layout>
    ...
    <div class="space-y-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs text-green-800/80 mt-1 leading-relaxed">
                            Kelola data <span class="font-semibold text-green-900">anggota Fatayat NU</span>
                            secara terpusat untuk mendukung administrasi keanggotaan dan monitoring wilayah organisasi.
                        </p>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ $anggota->total() }}</p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ $anggota->count() }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">
                            {{ $anggota->where('status_anggota', 'Aktif')->count() }}
                        </p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ $anggota->currentPage() }}</p>
                    </div>
        ...
        {{-- FILTER BAR --}}
        <x-ui.filter-bar :action="route('anggota.index')" placeholder="Cari nama anggota, PR, PAR, atau nomor KTA..." :statuses="['Aktif', 'Tidak Aktif']" />
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Data anggota Fatayat NU yang telah terdaftar dalam sistem organisasi.
                    </p>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-[#F8FBF8] transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            <p class="font-medium text-gray-900 truncate">{{ $item->nama_lengkap }}</p>
                                            <p class="text-xs text-gray-500 truncate">Anggota Fatayat Nahdlatul Ulama</p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-14 text-center">
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-4 text-gray-400">
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-500">Belum ada data anggota</p>
                                            <p class="text-sm text-gray-400 mt-1">
                                                Silakan tambahkan data anggota pertama untuk mulai mengelola keanggotaan organisasi.
                                            </p>
                                        </div>

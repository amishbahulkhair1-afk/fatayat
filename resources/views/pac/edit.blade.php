    ...
    <div class="space-y-6 max-w-5xl mx-auto">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    <h1 class="text-base font-semibold text-green-900 leading-tight">
                        Edit Pengurus Anak Cabang
                    </h1>

                    <p class="text-xs text-green-800/80 mt-1 leading-relaxed">
                        Perbarui data <span class="font-semibold text-green-900">PAC Nahdlatul Ulama</span>
                        beserta informasi pengurus inti dan data pendukung organisasi.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-3xl bg-white border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Form Edit PAC</h2>
                <p class="text-sm text-gray-500 mt-1">
                    Perbarui informasi organisasi dengan benar sebelum menyimpan perubahan data.
                </p>
            </div>

            <form action="{{ route('pac.update', $pac->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $pac->nama) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="kecamatan" value="{{ old('kecamatan', $pac->kecamatan) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-ui.date-input name="tanggal_dibentuk" label="Tanggal Dibentuk" :value="old('tanggal_dibentuk', $pac->tanggal_dibentuk)" required />

                    <div x-data="{
                        status: '{{ old('status', $pac->status ?? 'Aktif') }}',
                        labelStatus: '{{ old('status', $pac->status ?? 'Aktif') }}'
                    }">
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                Pilih pengurus yang menjabat sebagai ketua, sekretaris, dan bendahara.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        @foreach ($fields as $field => [$label, $placeholder])
                            <div x-data="{
                                selected: '{{ old($field, $pac->$field) }}',
                                selectedName: '{{ old($field, $pac->$field)
                                    ? optional($pengurus->firstWhere('id', old($field, $pac->$field)))->nama_lengkap
                                    : $placeholder }}'
                            }">
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <input type="text" name="kontak" value="{{ old('kontak', $pac->kontak) }}"
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                Tambahkan catatan atau informasi tambahan terkait PAC ini jika diperlukan.
                            </p>
                        </div>
                    </div>

                    <textarea name="keterangan" rows="5" placeholder="Catatan tambahan mengenai PAC..."
                        class="w-full rounded-2xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 shadow-sm focus:border-green-500 focus:ring-4 focus:ring-green-100 transition resize-none">{{ old('keterangan', $pac->keterangan) }}</textarea>
                </div>

    ...
    <div class="space-y-6 max-w-7xl mx-auto py-6">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    <h1 class="text-base font-semibold text-green-900 leading-tight">
                        Monitoring Program Kerja Lembaga PAC
                    </h1>

                    <p class="text-xs text-green-800/80 mt-1 leading-relaxed">
                        Pantau perkembangan <span class="font-semibold text-green-900">program kerja dan kegiatan lembaga PAC Pragaan</span>
                        secara terpusat untuk mendukung evaluasi pelaksanaan program dan efektivitas kegiatan organisasi.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center gap-2 mb-1">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">
                        Cari lembaga berdasarkan nama untuk melihat ringkasan program kerja dan kegiatan.
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 xl:grid-cols-6 gap-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500">Total Proker</p>
                        <p class="text-3xl font-bold text-gray-900 mt-2">
                            {{ $ringkasan['total_program_kerja'] }}
                        </p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500">Proker Selesai</p>
                        <p class="text-3xl font-bold text-green-700 mt-2">
                            {{ $ringkasan['proker_selesai'] }}
                        </p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500">Proker Belum</p>
                        <p class="text-3xl font-bold text-red-700 mt-2">
                            {{ $ringkasan['proker_tidak'] }}
                        </p>
                    </div>

                    <div
                        class="h-12 w-12 rounded-2xl bg-red-100 flex items-center justify-center text-red-700 text-xl">
                        ⏳
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500">Kegiatan Belum</p>
                        <p class="text-3xl font-bold text-red-700 mt-2">
                            {{ $ringkasan['kegiatan_tidak'] }}
                        </p>
                    </div>
        ...
        <div class="rounded-3xl bg-white border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Monitoring Lembaga</h3>
                    <p class="text-sm text-gray-500 mt-1">
                        Ringkasan pelaksanaan program kerja dan kegiatan di setiap lembaga PAC Pragaan.
                    </p>
                </div>
            </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 truncate">
                                                Lembaga PAC Fatayat NU Pragaan
                                            </p>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400 mt-1">
                                                Data lembaga dan program kerja belum tersedia untuk ditampilkan pada monitoring.
                                            </p>
                                        </div>

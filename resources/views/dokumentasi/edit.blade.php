    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <form action="{{ route('dokumentasi.update', $dokumentasi->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex items-start justify-between gap-4 pb-4 border-b border-gray-100">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Pastikan data dokumentasi sudah sesuai sebelum diperbarui.
                    </p>
                </div>
            ...
            <div class="space-y-2">
                ...
                <x-ui.input name="judul_dokumentasi" :value="old('judul_dokumentasi', $dokumentasi->judul_dokumentasi)" placeholder="Masukkan judul dokumentasi" />
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div x-data="{
                    openKategori: false,
                    labelKategori: '{{ old('kategori', $dokumentasi->kategori) ?: 'Pilih kategori kegiatan' }}'
                }" class="space-y-2">
                    ...
                    <input type="hidden" name="kategori" value="{{ old('kategori', $dokumentasi->kategori) }}">
                ...
                <div class="space-y-2">
                    ...
                    <x-ui.input type="date" name="tanggal_kegiatan" :value="old('tanggal_kegiatan', $dokumentasi->tanggal_kegiatan)" />
            ...
            <div class="space-y-2">
                ...
                <textarea name="deskripsi_singkat" rows="4"
                    ...
                    placeholder="Tulis deskripsi singkat dokumentasi kegiatan...">{{ old('deskripsi_singkat', $dokumentasi->deskripsi_singkat) }}</textarea>
            </div>
            ...
            <div class="space-y-4 rounded-2xl border border-gray-100 bg-gray-50/70 p-5">
                ...
                <div class="flex items-center justify-between gap-3">
                    ...
                    @if ($dokumentasi->foto)
                        <a href="{{ Storage::url($dokumentasi->foto) }}" target="_blank"
                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-start">
                    ...
                    @if ($dokumentasi->foto)
                        <img src="{{ Storage::url($dokumentasi->foto) }}" alt="Foto dokumentasi"
                            class="h-28 w-full rounded-2xl object-cover border border-gray-200 shadow-sm md:w-44">
                    @else
                        <div
                            class="h-28 w-full rounded-2xl border border-dashed border-gray-300 bg-white flex items-center justify-center text-xs text-gray-400 md:w-44">
                            Belum ada foto
                        </div>
                    @endif
                ...
                <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                    ...
                    <label
                        ...
                        <input type="radio" name="status" value="Publikasi"
                            ...
                            {{ old('status', $dokumentasi->status) == 'Publikasi' ? 'checked' : '' }}>
                    ...
                    <label
                        ...
                        <input type="radio" name="status" value="Draft"
                            ...
                            {{ old('status', $dokumentasi->status) == 'Draft' ? 'checked' : '' }}>

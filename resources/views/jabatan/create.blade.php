    ...
    <div class="space-y-6 max-w-5xl mx-auto">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs text-green-800/80 mt-1 leading-relaxed">
                        Tambahkan data <span class="font-semibold text-green-900">jabatan pengurus</span>
                        beserta informasi organisasi, periode kepengurusan, dan status jabatan.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-3xl bg-white border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Form Tambah Jabatan</h2>
                <p class="text-sm text-gray-500 mt-1">
                    Lengkapi informasi jabatan pengurus dengan benar sebelum menyimpan data.
                </p>
            </div>

            <form action="{{ route('jabatan.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{
                        pengurus: '{{ old('pengurus_id') }}',
                        namaPengurus: 'Pilih Pengurus'
                    }">
                        ...
                        <input type="hidden" name="pengurus_id" :value="pengurus">
                ...
                <div class="border-t border-gray-100 pt-6">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                Pilih salah satu organisasi tempat jabatan ini berlaku.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div x-data="{
                            pac_id: '{{ old('pac_id') }}',
                            pac_label: '{{ old('pac_id') ? optional($pac->firstWhere('id', old('pac_id')))->nama : '-- Tidak Dipilih --' }}'
                        ...
                        <div x-data="{
                            pr_id: '{{ old('pr_id') }}',
                            pr_label: '{{ old('pr_id') ? optional($pr->firstWhere('id', old('pr_id')))->nama : '-- Tidak Dipilih --' }}'
                        }" class="space-y-2 relative">
                        ...
                        <div x-data="{
                            par_id: '{{ old('par_id') }}',
                            par_label: '{{ old('par_id') ? optional($par->firstWhere('id', old('par_id')))->nama : '-- Tidak Dipilih --' }}'
                        }" class="space-y-2 relative">
                        ...
                        <div x-data="{
                            ...
                            lembaga_label: '{{ old('lembaga_id')
                                ? optional($lembaga->firstWhere('id', old('lembaga_id')))->nama_lembaga
                                : '-- Tidak Dipilih --' }}'
                        }" class="space-y-2 relative">
                ...
                <div class="border-t border-gray-100 pt-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="periode_selesai" value="{{ old('periode_selesai') }}"
                                placeholder="2027"
                                class="w-full rounded-2xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 shadow-sm focus:border-green-500 focus:ring-4 focus:ring-green-100 transition">
                        ...
                        <div x-data="{
                            ...
                            <x-ui.dropdown width="64" align="left">
                                ...
                                <x-slot name="content">
                                    ...
                                    <button type="button"
                                        @click="status = 'Purna Tugas'; labelStatus = 'Purna Tugas'"

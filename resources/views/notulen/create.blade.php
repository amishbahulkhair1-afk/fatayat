    ...
    <div class="py-6 max-w-3xl mx-auto">
        ...
        <form action="{{ route('notulen.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="border-b border-gray-100 pb-4">
                <h3 class="text-lg font-semibold text-gray-900">Form Tambah Notulen</h3>
                <p class="text-sm text-gray-500 mt-1">
                    Tambahkan dokumentasi hasil rapat atau kegiatan organisasi PAC Fatayat NU Pragaan.
                </p>
            </div>

            {{-- Kegiatan --}}
            <div x-data="{
                labelKegiatan: '{{ old('kegiatan_id')
                    ? optional($kegiatan->firstWhere('id', old('kegiatan_id')))->nama_kegiatan .
                        ' (' .
                        optional($kegiatan->firstWhere('id', old('kegiatan_id')))->tanggal_kegiatan .
                        ')'
                ...
                <input type="hidden" name="kegiatan_id" value="{{ old('kegiatan_id') }}">
            ...
            {{-- Judul --}}
            <div>
                <x-ui.input name="judul" label="Judul Notulen" :value="old('judul')"
            ...
            {{-- Tanggal --}}
            <div>
                <x-ui.date-input name="tanggal" label="Tanggal Rapat" :value="old('tanggal')" />
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <x-ui.input name="pemimpin_rapat" label="Pemimpin Rapat" :value="old('pemimpin_rapat')"
                        placeholder="Nama pemimpin rapat" />
                </div>

                <div>
                    <x-ui.input name="notulis" label="Notulis" :value="old('notulis')" placeholder="Nama notulis" />
                </div>
            </div>
            ...
            <div>
                <x-ui.textarea name="isi_notulen" label="Isi Notulen" rows="10"
                    placeholder="Tuliskan hasil rapat, poin pembahasan, keputusan, dan tindak lanjut...">{{ old('isi_notulen') }}</x-ui.textarea>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Format yang didukung: PDF, DOC, dan DOCX.
                            </p>
                        </div>
                    </div>
                </div>

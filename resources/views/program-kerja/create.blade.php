<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Tambah Program Kerja - {{ $lembaga->nama_lembaga }}</h2>
    </x-slot>
    ...
    <div class="py-6 max-w-2xl mx-auto">
        <form action="{{ route('lembaga.program-kerja.store', $lembaga->id) }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="nama_program_kerja" value="{{ old('nama_program_kerja') }}"
            ...
            <div>
                ...
                <select name="status" class="w-full border rounded p-2">
                    <option value="Tidak Selesai" {{ old('status') == 'Tidak Selesai' ? 'selected' : '' }}>Tidak Selesai
                    </option>

    ...
    <div class="space-y-6 max-w-5xl mx-auto">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    <h1 class="text-base font-semibold text-green-900 leading-tight">
                        Tambah Pimpinan Ranting
                    </h1>

                    <p class="text-xs text-green-800/80 mt-1 leading-relaxed">
                        Tambahkan data <span class="font-semibold text-green-900">PR Nahdlatul Ulama</span>
                        baru beserta informasi pengurus inti dan data pendukung organisasi tingkat desa atau kelurahan.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-3xl bg-white border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Form Tambah PR</h2>
                <p class="text-sm text-gray-500 mt-1">
                    Lengkapi informasi pimpinan ranting dengan benar sebelum menyimpan data.
                </p>
            </div>

            <form action="{{ route('pr.store') }}" method="POST" class="p-6 space-y-6">
                @csrf

                <!-- PAC INDUK -->
                <div x-data="{
                    pac: '{{ old('pac_id') }}',
                    namaPac: '{{ old('pac_id') ? optional($pac->firstWhere('id', old('pac_id')))->nama : 'Pilih PAC Induk' }}'
                }">
                    ...
                    <input type="hidden" name="pac_id" :value="pac">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_pr" value="{{ old('kode_pr') }}" placeholder="Contoh: PR-001"
                            class="w-full rounded-2xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 shadow-sm focus:border-green-500 focus:ring-4 focus:ring-green-100 transition">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                Pilih pengurus yang menjabat sebagai ketua, sekretaris, dan bendahara PR.
                            </p>
                        </div>
                    </div>
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                Tambahkan informasi kontak dan alamat sekretariat yang dapat dihubungi.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_sekertaris" value="{{ old('alamat_sekertaris') }}"
